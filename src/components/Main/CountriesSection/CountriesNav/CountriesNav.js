...
import { clearSearchResultsActionCreator, setSearchResultsActionCreator } from "../../../../Redux/searchHotel/searchHotelResultsAction";
                                ...
                                <div className="DivForCountriesList">
                                    ...
                                    <div className={showCountriesList ? "showSelectedList" : "hideSelectedList"}>
                                        <div className="turkeyHotels">
                                            ...
                                            <NavLink to="/countries/turkey" className="LinkForCountry"
                                            onClick={() => {
                                        ...
                                        <div className="egyptHotels">
                                            ...
                                            <NavLink to="/countries/egypt" className="LinkForCountry"
                                            onClick={() => {
                                                dispatch(clearSearchResultsActionCreator());
                                              }}>Єгипет</NavLink>
                                        </div>
                                        ...
                                        <div className="OAEHotels">
                                            ...
                                            <NavLink to="/countries/OAE" className="LinkForCountry"
                                            onClick={() => {
                                                dispatch(clearSearchResultsActionCreator());
                                              }}>ОАЕ</NavLink>
                                        </div>
